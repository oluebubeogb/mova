...
<?php endif; ?>
<form method="post" action="/hq/style/reset" class="design-reset-form" style="margin:0 0 1rem;" onsubmit="return confirm('Reset style to Mova defaults? This overwrites your current style settings.');">
    <?= Csrf::field() ?>
